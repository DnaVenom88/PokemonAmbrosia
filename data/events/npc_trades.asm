...
; entries correspond to NPCTRADE_* constants
	...
	npctrade TRADE_DIALOGSET_COLLECTOR, GIBLE,       GLIGAR,       "ALUCARD@@@@", $DD, $DD, BRIGHTPOWDER,00666,  "DRACULA@@@@", TRADE_GENDER_EITHER
	npctrade TRADE_DIALOGSET_COLLECTOR, LARVITAR,    BAGON,        "TOOTHLESS@@", $DD, $DD, DRAGON_SCALE, 02010,  "HICCUP@@@@@", TRADE_GENDER_EITHER
